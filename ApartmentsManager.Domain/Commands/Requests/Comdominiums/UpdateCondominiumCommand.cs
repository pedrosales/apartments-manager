...
{
    public class UpdateCondominiumCommand : Notifiable, ICommand
    {
        public UpdateCondominiumCommand() { }
        public UpdateCondominiumCommand(Guid id, string name, string street, int number, string neighborhood, string city, string state, string country, string zipCode, string user)
        {
            Id = id;
            Name = name;
            Street = street;
